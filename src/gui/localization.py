...
LOCALIZATION = {
    "ru": {
        ...
        "confirm_delete_text": "Вы уверены, что хотите удалить '{0}'?",
        ...
        "ann_file_required": "Необходимо выбрать аудиофайл для объявления.",
        ...
        "ann_volume": "Громкость объявлений:",
        "ann_col_days": "Дни",
    ...
    "en": {
        ...
        "confirm_delete_text": "Are you sure you want to delete '{0}'?",
        ...
        "ann_file_required": "An audio file must be selected for the announcement.",
        ...
        "ann_days_label": "Days:",
        "ann_time_group": "Time",
        "ann_volume": "Announcements volume:",
        "ann_col_days": "Days",
